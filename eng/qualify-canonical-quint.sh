...
"$tool_path/fsgg-sdd" evidence --root . --work 66-gs2-02-11-deterministic-identity \
  --sync-observed-run artifacts/test-results/66-gs2-02-11-deterministic-identity/architecture-tests.trx --text
