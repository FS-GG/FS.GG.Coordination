...
if fsi.CommandLineArgs |> Array.contains "--mint" then printfn "%s" report.Seal
    ...
    let generatedMutation = function
        ...
        | QuintUnchanged ->
            ...
            sha256Bytes bytes = "226ddc49e59dd2f8e9c140e57da92dda7f5a00cd02ccfb07885753117d2bd95b"
            && sha256Bytes (Array.append bytes [| 0uy |]) <> "226ddc49e59dd2f8e9c140e57da92dda7f5a00cd02ccfb07885753117d2bd95b"
        | NoApplySurface ->
