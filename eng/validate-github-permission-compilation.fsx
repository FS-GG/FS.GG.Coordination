...
if fsi.CommandLineArgs |> Array.contains "--mint" then printfn "%s" report.Seal else
    ...
    let generatedMutation = function
        ...
        | QuintPermissionUnchanged -> sha256File (Path.Combine(root, "src/FS.GG.Coordination.Protocol/Protocol.md")) = "3387a7d61d51ed35495e041bd26679af3d9cad63f2389443dc97368e14ac8118"
