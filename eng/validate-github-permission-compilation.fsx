...
if fsi.CommandLineArgs |> Array.contains "--mint" then printfn "%s" report.Seal else
    ...
    let generatedMutation = function
        ...
        | QuintPermissionUnchanged -> sha256File (Path.Combine(root, "src/FS.GG.Coordination.Protocol/Protocol.md")) = "735d7a6a259facf8b12c38a82e621f321b191ee8a0cf5138f2a1434384c4c2d9"
