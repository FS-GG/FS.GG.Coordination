...
The apply sequence is deliberately staged: merge CODEOWNERS and this contract, enable supported repository
security and selected GitHub-owned Actions, create the signed immutable `v*` tag ruleset, and create the
...
six exact GitHub Actions checks proven by bootstrap qualification. The release-tag ruleset has no bypass,
