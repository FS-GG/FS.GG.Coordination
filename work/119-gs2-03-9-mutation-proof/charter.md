...
# Prove the qualification harness can fail Charter

## Identity
- Work id: `119-gs2-03-9-mutation-proof`
...
## Lifecycle Notes
- Next lifecycle action: `fsgg-sdd specify --work 119-gs2-03-9-mutation-proof`.
