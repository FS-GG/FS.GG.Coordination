...
- FR-005: Every category MUST have focused inversions for missing case, duplicate case/key, source substitution, identity drift, stale or incomplete output, incorrect count, non-canonical order, malformed envelope, and digest tampering. Each inversion MUST reach the production validator and produce a stable named refusal. (Stories: US-003; Acceptance: AC-003)
