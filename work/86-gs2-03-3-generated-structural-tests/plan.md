...
- PD-005 [AC-003] [FR-005] complete: Add architecture tests that invoke the production generator and validator against isolated fixture copies; invert missing and substituted cases per category; invert duplicate, reordered, identity-drifted, stale, malformed, mislabeled, digest-tampered, and independently readable producer-omission cases across the suite with stable refusal codes.
