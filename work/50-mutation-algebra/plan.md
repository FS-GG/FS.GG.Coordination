...
- PD-002 [AC-001] [FR-002] complete: Bind operation id, subject, expected revision, idempotency key, mutation kind, and canonical payload digest. Exact key-and-intent replay returns the original result without another state change; any bound-field substitution is a conflict.
