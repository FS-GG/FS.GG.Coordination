...
# Gs2 07 5 Merge Group Support Checklist

Prose status: checklistReady

## Source Specification
- work/315-gs2-07-5-merge-group-support/spec.md
...
- Next lifecycle action: `fsgg-sdd plan --work 315-gs2-07-5-merge-group-support`.
