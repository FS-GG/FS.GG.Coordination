...
- checklist: work/315-gs2-07-5-merge-group-support/checklist.md sha256:3a9faeae44261613a916268623c1dff95162f56a5f253fc13b2554098353e4a7 schemaVersion:1
...
## Plan Decisions
- PD-001 [AC-001] [FR-001] complete: Add a pure `GitHubMergeGroupQualification` module. It accepts a canonical checks-requested merge-group event only after exact syntax, complete aggregate check success, unexpired base observation, and equality between observed and freshly re-observed base, claim, review, head, dependency, release, and settings facts.
...
- VO-001 [PD-001] [PC-001] semanticTest: Run focused positive/boundary tests, stale and changed base tests, all generated adversarial mutations, independently authored control inventory, gate inversion proving validator failure, registered Q3 command, full unit and architecture suites, warning-free Release build, exact replay, and clean-candidate roadmap qualification.
