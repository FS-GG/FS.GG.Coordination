...
# GS2-04.2 typed GitHub issue and field adapter Charter

## Identity
- Work id: `gs2-04-2-issue-field-adapter`
...
## Lifecycle Notes
- Next lifecycle action: `fsgg-sdd specify --work gs2-04-2-issue-field-adapter`.
