...
## Source Snapshot
- spec: work/228-required-check-census/spec.md sha256:d746c08789fb3411fa9e8e7d4d2c9d062a029bef691ad47968c0d3b9c5955e8a schemaVersion:1
- clarifications: work/228-required-check-census/clarifications.md sha256:898be04011c968024edb83eabed69ca306d9c28e39df370f9334bb341dfb612a schemaVersion:1
...
- PD-002 [AC-001] [FR-001] complete: Model unconditional production as an explicit closed proof for `pull_request` and `merge_group`: both events are admitted, event filters and activity restrictions are absent, and every job/dependency fact is complete with no condition or continue-on-error escape. Unknown, partial, filtered, conditional, renamed, cross-repository, duplicate, and stale observations fail closed.
