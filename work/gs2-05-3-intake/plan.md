...
- PD-006 [AC-003] [FR-006] [DEC-003] complete: Restrict protocol initialization intents to the five registered families—protocol issue, Project membership, hierarchy, dependencies, and required issue fields—and reject any mutation outside that closed set before a plan is sealed.
