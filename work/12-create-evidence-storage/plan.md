...
- checklist: work/12-create-evidence-storage/checklist.md sha256:ab5ed795bf4c4abf312f50db14f3a3682c98a2422968c23db9274786162a0b82 schemaVersion:1
...
- PD-004 [AC-004] [FR-004] complete: Implement a dependency-free offline F# gate that exhaustively validates every indexed record against its category contract, including strict lowercase revisions/digests, nonempty identities, complete accepted-receipt artifact shapes, and canonical second-precision UTC timestamps. Exercise one positive immutable artifact manifest and 21 isolated negative mutations spanning all eight categories plus versions, digests, paths, duplicates, ordering, schemas, categories, mutable locators, sizes, and symbolic links.
