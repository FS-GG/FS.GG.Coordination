...
# GS2-04.8 Actions Release Feed Adapter Charter

## Identity
- Work id: `gs2-04-8-actions-release-feed-adapter`
...
## Lifecycle Notes
- Next lifecycle action: `fsgg-sdd specify --work gs2-04-8-actions-release-feed-adapter`.
