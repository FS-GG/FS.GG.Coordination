...
## Source Snapshot
- spec: work/20-complete-repository-provisioning/spec.md sha256:fec1e63b73a013ae194bae1ed27ed251722d8c741c7358e50bb3f0f4915afd4a schemaVersion:1
...
- PD-005 [AC-005] [FR-005] complete: Add a dependency-free F# validator over a versioned desired-state contract and compact receipt. Capture complete paginated REST responses, separately bind repository workflow permissions and the organization Actions-permissions 403, normalize only declared fields in fixed order, hash raw bytes, record operation outcomes and rollback guidance, and publish the exact post-state receipt on the accountable issue for independent acceptance.
