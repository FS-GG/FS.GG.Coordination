...
module OrganizationIssueFields =
    ...
    val validate:
        OrganizationIssueFieldObservation ->
            Result<NormalizedOrganizationIssueFields, OrganizationIssueFieldDiagnostic list>

    val plan:
        OrganizationIssueFieldObservation list ->
            Result<OrganizationIssueFieldDisposition list, OrganizationIssueFieldRefusal list>
