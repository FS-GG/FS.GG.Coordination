...
module IntakeAdapter =
    ...
    val planCapture:
        StagedCaptureRequest -> StagedCaptureObservation -> Result<StagedCapturePlan, IntakeDiagnostic list>

    val prepareReadyPromotion:
        identity: string ->
        repository: string ->
        causation: string ->
        ReadyPromotionFact list ->
            Result<CanonicalIntakeIntent, IntakeDiagnostic list>
