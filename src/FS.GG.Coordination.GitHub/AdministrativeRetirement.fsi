...
module AdministrativeRetirement =
    ...
    val validatePreflight:
        now: DateTimeOffset ->
        maxAge: TimeSpan ->
        RetirementIdentity ->
        RetirementObservation ->
            Result<RetirementObservation, AdministrativeRetirementFailure list>
    ...
    val settle:
        ...
        RetirementIdentity ->
        RetirementObservation ->
            Result<AdministrativeRetirementResult, AdministrativeRetirementFailure list>
    ...
    val verify:
        ...
        RetirementIdentity ->
        RetirementObservation ->
        AdministrativeRetirementReceipt ->
            Result<AdministrativeRetirementResult, AdministrativeRetirementFailure list>
