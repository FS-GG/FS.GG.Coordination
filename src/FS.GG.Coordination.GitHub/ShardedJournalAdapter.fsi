...
module ShardedJournalAdapter =
    ...
    val planCas:
        operationId: string -> JournalSnapshot -> proposed: JournalCommit -> Result<CasProposal, JournalFailure>
    ...
    val planConflict:
        SagaPlan -> acquired: SagaTouch list -> applied: SagaTouch list -> Result<SagaConflictPlan, string>
