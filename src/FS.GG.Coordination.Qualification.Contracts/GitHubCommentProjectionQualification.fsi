...
module GitHubCommentProjectionQualification =
    ...
    val validate:
        generated: GitHubCommentProjectionControlResult list ->
        independent: GitHubCommentProjectionControlResult list ->
            Result<unit, GitHubCommentProjectionFinding list>
