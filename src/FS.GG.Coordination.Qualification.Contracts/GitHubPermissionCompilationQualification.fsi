...
module GitHubPermissionCompilationQualification =
    ...
    val compile:
        GitHubPermissionCompilationSnapshot ->
            Result<GitHubPermissionCompilationReport, GitHubPermissionCompilationFinding list>
    ...
    val validate:
        GitHubPermissionCompilationControlResult list ->
        GitHubPermissionCompilationControlResult list ->
            Result<unit, GitHubPermissionCompilationQualificationFinding list>
