...
module GitHubRequiredCheckCensusQualification =
    ...
    val validate:
        generated: GitHubRequiredCheckCensusControlResult list ->
        independent: GitHubRequiredCheckCensusControlResult list ->
            Result<unit, GitHubRequiredCheckCensusFinding list>
