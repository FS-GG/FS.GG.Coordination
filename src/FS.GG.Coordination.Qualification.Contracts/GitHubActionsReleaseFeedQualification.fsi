...
module GitHubActionsReleaseFeedQualification =
    ...
    val validate:
        generated: GitHubActionsReleaseFeedControlResult list ->
        independent: GitHubActionsReleaseFeedControlResult list ->
            Result<unit, GitHubActionsReleaseFeedFinding list>
