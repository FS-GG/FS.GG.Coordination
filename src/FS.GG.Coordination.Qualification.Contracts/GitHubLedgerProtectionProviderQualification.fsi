...
module GitHubLedgerProtectionProviderQualification =
    ...
    val validate:
        generated: GitHubLedgerProtectionProviderControlResult list ->
        independent: GitHubLedgerProtectionProviderControlResult list ->
            Result<unit, GitHubLedgerProtectionProviderFinding list>
