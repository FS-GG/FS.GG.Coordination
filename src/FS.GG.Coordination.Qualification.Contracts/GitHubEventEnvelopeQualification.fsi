...
module GitHubEventEnvelopeQualification =
    ...
    val compile:
        source: GitHubEventSource ->
        deliveries: GitHubEventDelivery list ->
            Result<GitHubEventEnvelope, GitHubEventEnvelopeFinding list>

    val serialize: GitHubEventEnvelope -> string
    val parse: string -> Result<GitHubEventEnvelope, GitHubEventEnvelopeFinding list>

    val verify:
        expectedSeal: string -> GitHubEventEnvelope -> Result<GitHubEventEnvelope, GitHubEventEnvelopeFinding list>

    val replay:
        prior: GitHubEventEnvelope ->
        source: GitHubEventSource ->
        deliveries: GitHubEventDelivery list ->
            Result<GitHubEventEnvelope, GitHubEventEnvelopeFinding list>

    val validateControls:
        generated: GitHubEventEnvelopeControlResult list ->
        independent: GitHubEventEnvelopeControlResult list ->
