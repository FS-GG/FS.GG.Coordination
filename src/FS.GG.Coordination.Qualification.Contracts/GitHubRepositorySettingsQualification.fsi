...
module GitHubRepositorySettingsQualification =
    ...
    val validate:
        generated: GitHubRepositorySettingsControlResult list ->
        independent: GitHubRepositorySettingsControlResult list ->
            Result<unit, GitHubRepositorySettingsFinding list>
