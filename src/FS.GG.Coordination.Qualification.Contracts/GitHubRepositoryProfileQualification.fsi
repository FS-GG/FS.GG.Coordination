...
type GitHubRepositoryProfileFinding =
    {
        Code: string
        ControlId: string
        Message: string
...
module GitHubRepositoryProfileQualification =
    ...
    val validate:
        generated: GitHubRepositoryProfileControlResult list ->
        independent: GitHubRepositoryProfileControlResult list ->
            Result<unit, GitHubRepositoryProfileFinding list>
