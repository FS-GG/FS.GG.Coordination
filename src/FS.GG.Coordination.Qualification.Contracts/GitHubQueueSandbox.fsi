...
module GitHubQueueSandbox =
    ...
    val replayPilot:
        prior: QueuePilotPlan -> facts: QueuePilotFacts -> Result<QueuePilotPlan, GitHubQueueSandboxFinding list>
    ...
    val verifyRecovery:
        expectedSeal: string -> QueueRecoveryReceipt -> Result<QueueRecoveryReceipt, GitHubQueueSandboxFinding list>

    val replayRecovery:
        prior: QueueRecoveryReceipt ->
        facts: QueueRecoveryFacts ->
            Result<QueueRecoveryReceipt, GitHubQueueSandboxFinding list>
    ...
    val verifyBurst:
        expectedSeal: string -> QueueBurstReceipt -> Result<QueueBurstReceipt, GitHubQueueSandboxFinding list>
