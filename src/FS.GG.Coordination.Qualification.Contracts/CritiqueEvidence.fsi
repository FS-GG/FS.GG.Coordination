...
module CritiqueEvidence =
    ...
    val generate: input: CritiqueEvidenceInput -> Result<byte array, CritiqueEvidenceFinding list>

    val validate:
        expected: CritiqueEvidenceInput ->
        artifact: ReadOnlyMemory<byte> ->
            Result<CritiqueEvidenceSummary, CritiqueEvidenceFinding list>
