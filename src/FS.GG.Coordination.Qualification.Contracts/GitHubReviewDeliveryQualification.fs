...
type GitHubReviewDeliveryControl =
    | StableChain
    | ImmutableEpoch
    | CompleteSnapshot
    | FreshEpochSeat
...
type GitHubReviewDeliveryControlResult =
    {
        Control: GitHubReviewDeliveryControl
        MutationRed: bool
        BaselineGreen: bool
    }

type GitHubReviewDeliveryFinding =
    {
        Code: string
        ControlId: string
        Message: string
...
module GitHubReviewDeliveryQualification =
    ...
    let requiredControls =
        [
            GitHubReviewDeliveryControl.StableChain
            GitHubReviewDeliveryControl.ImmutableEpoch
            GitHubReviewDeliveryControl.CompleteSnapshot
            GitHubReviewDeliveryControl.FreshEpochSeat
            GitHubReviewDeliveryControl.SameEpochSuccession
            GitHubReviewDeliveryControl.AccountableAuthority
            GitHubReviewDeliveryControl.HistoricalPass
            GitHubReviewDeliveryControl.CurrentPass
            GitHubReviewDeliveryControl.ReviewFence
            GitHubReviewDeliveryControl.MergeDistinct
            GitHubReviewDeliveryControl.ProtectedMain
            GitHubReviewDeliveryControl.ExactMergeRun
            GitHubReviewDeliveryControl.DeliveryReceipt
            GitHubReviewDeliveryControl.DoneReceipt
            GitHubReviewDeliveryControl.ExactReplay
            GitHubReviewDeliveryControl.DivergentReplay
    ...
    let validate generated independent =
        ...
        let findings =
            validateSet "GRDQ-GENERATED" generated
            @ validateSet "GRDQ-INDEPENDENT" independent
