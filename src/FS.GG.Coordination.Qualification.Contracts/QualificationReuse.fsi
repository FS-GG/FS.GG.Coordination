...
val decide:
    ...
    subjectSha256: string ->
    prior: PriorRun option ->
    priorSubjectSha256: string option ->
        Decision
...
val validatePriorAggregateBinding:
    currentPlan: PartitionPlan -> priorPlan: PartitionPlan -> receipt: CoherentAggregateReceipt -> Result<unit, string>

val createPartitionReceipt:
    plan: PartitionPlan -> partition: int -> obligations: string list -> passed: bool -> PartitionReceipt
