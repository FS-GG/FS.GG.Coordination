...
module QualificationManifest =
    ...
    val generate: input: QualificationManifestInput -> Result<byte array, QualificationManifestFinding list>

    val generateInventory:
        expected: QualificationManifestExpectedInventory -> Result<byte array, QualificationManifestFinding list>

    val validate:
        inventory: ReadOnlyMemory<byte> ->
        manifest: ReadOnlyMemory<byte> ->
            Result<byte array, QualificationManifestFinding list>
