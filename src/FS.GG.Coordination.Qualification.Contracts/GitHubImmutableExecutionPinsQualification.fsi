...
module GitHubImmutableExecutionPinsQualification =
    val classifyReferenceLiteral:
        literal: string ->
            Result<ImmutableExecutionReferenceKind * string * string option * string, ImmutableExecutionPinsError list>

    val compile:
        ImmutableExecutionPinsSnapshot -> Result<ImmutableExecutionPinsReport, ImmutableExecutionPinsError list>

    val verify:
        expectedSeal: string ->
        ImmutableExecutionPinsSnapshot ->
            Result<ImmutableExecutionPinsReport, ImmutableExecutionPinsError list>

    val requiredControls: GitHubImmutableExecutionPinsControl list
    val controlId: GitHubImmutableExecutionPinsControl -> string

    val validate:
        generated: GitHubImmutableExecutionPinsControlResult list ->
        independent: GitHubImmutableExecutionPinsControlResult list ->
            Result<unit, GitHubImmutableExecutionPinsFinding list>
