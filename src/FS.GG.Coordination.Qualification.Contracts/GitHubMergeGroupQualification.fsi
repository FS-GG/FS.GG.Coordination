...
module GitHubMergeGroupQualification =
    ...
    val verify:
        expectedSeal: string -> GitHubMergeGroupPlan -> Result<GitHubMergeGroupPlan, GitHubMergeGroupFinding list>

    val replay:
        prior: GitHubMergeGroupPlan ->
        facts: GitHubMergeGroupFacts ->
            Result<GitHubMergeGroupPlan, GitHubMergeGroupFinding list>

    val validateControls:
        generated: GitHubMergeGroupControlResult list ->
        independent: GitHubMergeGroupControlResult list ->
