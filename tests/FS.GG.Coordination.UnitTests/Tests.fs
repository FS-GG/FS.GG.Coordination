...
let ``generated protocol contract exposes stable profile-2 identities`` () =
    ...
    Assert.Equal("1b68e99361f6ed3cc5762f31d3e32c7c6fa8bc4a0a06a127aa8ce94886cb9528", outputRoot.GetProperty("sourceSha256").GetString())
    Assert.Equal("c60fb49e78385bbd50e21b20bc90a1d682f967de8c2825690aca81d25d3db132", outputRoot.GetProperty("behavioralSha256").GetString())
