...
let ``event envelope surface remains pure and repository local`` () =
    let source =
        read "src/FS.GG.Coordination.Qualification.Contracts/GitHubEventEnvelopeQualification.fs"

    let signature =
        read "src/FS.GG.Coordination.Qualification.Contracts/GitHubEventEnvelopeQualification.fsi"
...
let ``generated and independent retained cases are complete and distinct`` () =
    ...
    let generated =
        cases "evidence/github-substrate-v2/gs2-07-1/generated-controls.json"

    let independent =
        cases "evidence/github-substrate-v2/gs2-07-1/independent-controls.json"
