...
let ``native unit binds the exact landed roadmap prerequisite and Q3 command`` () =
    ...
    Assert.Equal("7045ca44b160380b3474e2b5bc0304ca873c70b8", roadmap.GetProperty("revision").GetString())
    Assert.Equal("20f4f2bcdcd6e2bfdd787edc66efbe30a21289f7ddf2030a8b1b3ae2150b7c52", roadmap.GetProperty("sha256").GetString())
    let unit =
