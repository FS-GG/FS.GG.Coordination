...
let ``committed generated suite is complete deterministic and source bound`` () =
    ...
    Assert.Equal("fbffab4b3ce50658ead8552fa539c2284fa2154fb14a3a72b11596112657eb34", summary.SelfSha256)
    Assert.Equal("51abd02a655f8ee282c818b3085f32e79927ea160226b4778f9f35798fe60f17", sha256 committed)
...
[<Fact>]
let ``compact evidence record binds the committed generated bytes`` () =
    ...
    Assert.Equal(sha256 (File.ReadAllBytes artifactPath), evidence.GetProperty("sha256").GetString())
